    ...
    export default {
      ...
      data () {
          return {
              ...
              styles: {
                  color: 'blue',
                  background: `url(${bigImage}) center`
              }
          }
      }
    }
